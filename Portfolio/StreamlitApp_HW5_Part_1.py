...
FEATURE_KEYS = ["IBM_CR_Cum", "GOOGL_CR_Cum"]
...
MODEL_INFO = {
    ...
    "keys": FEATURE_KEYS,
    "inputs": [
        {"name": k, "type": "number", "min": -100.0, "max": 100.0, "default": 0.0, "step": 10.0}
...
def display_explanation(input_df, session, aws_bucket):
    ...
    # Preprocessing = everything except the final model step
    ...
    try:
        ...
        feature_names = [f'KPCA_{j}' for j in range(input_df_transformed.shape[1])]
...
st.title("👨‍💻 NVDA Cumulative Future Return Predictor")
